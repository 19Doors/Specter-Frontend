...
export default function Home() {
	...
	const [isPendingTransition, startTransition] = useTransition(); // Add transition hook
								...
								<div className="mr-auto text-sm font-merri pl-2 pb-2">
									<DropdownMenu>
										<DropdownMenuTrigger asChild>
											<Button variant="link" size="sm" className="text-foreground shadow-none text-[14px] font-inter tracking-tight font-bold outline-none rounded-xs">
							...
							<div className="w-full flex justify-center">
								<div className="w-full md:w-1/3 flex flex-col gap-sm bg-[#F5F5F5] border-1 border-[#E0E0E0] rounded-sm">
									...
									<div className="mr-auto text-sm font-merri pl-2 pb-2">
										<DropdownMenu>
											<DropdownMenuTrigger asChild>
												<Button variant="link" size="sm" className="text-[#0a0a0a] shadow-none text-[14px] font-inter tracking-tight font-bold outline-none rounded-xs">
													<Plus size={10} /> Files and sources
												</Button>
											</DropdownMenuTrigger>
											<DropdownMenuContent className="rounded-xs">
